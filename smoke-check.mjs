...
const checks = [
  ...
  },
  {
    ...
    test: () => competitionVoteRenderSource.includes('class="judge-lane-note competition-vote-feedback"')
      ...
      && competitionVoteClickSource.includes("const pendingVoteRequest = {")
      && competitionVoteClickSource.includes("pendingCompetitionVote = pendingVoteRequest")
      && competitionVoteClickSource.includes("await submitCompetitionJudgeVote")
      && competitionVoteClickSource.includes("if (pendingCompetitionVote === pendingVoteRequest) pendingCompetitionVote = null")
      && competitionVoteClickSource.indexOf("pendingCompetitionVote = pendingVoteRequest") < competitionVoteClickSource.indexOf("await submitCompetitionJudgeVote")
      && competitionVoteClickSource.indexOf("if (pendingCompetitionVote === pendingVoteRequest) pendingCompetitionVote = null") > competitionVoteClickSource.indexOf("await submitCompetitionJudgeVote")
      ...
      && competitionVoteSubmitSource.includes("matchesCompetitionAttemptFingerprint(remoteState, submissionEntryKey, submissionAttemptId)")
      && competitionVoteClickSource.includes("expectedFingerprint.attemptId")
      && competitionVoteClickSource.includes("expectedFingerprint.entryKey")
  ...
  },
  {
    ...
    test: () => qualifyingJudgeSubmitSource.includes("remoteRevisionAtSubmit")
      ...
      && competitionScorecardSubmitSource.includes("matchesCompetitionAttemptFingerprint(remoteState, submissionEntryKey, submissionAttemptId)")
      && competitionVoteClickSource.includes("expectedFingerprint.entryKey")
      && competitionVoteClickSource.includes("expectedFingerprint.attemptId")
