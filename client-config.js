window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=200f91748cef",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=200f91748cef",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=200f91748cef",
    homeHeroImage: "./assets/track-background.png?v=200f91748cef",
