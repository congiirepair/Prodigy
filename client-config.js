window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=1a0f333a0528",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=1a0f333a0528",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=1a0f333a0528",
    homeHeroImage: "./assets/track-background.png?v=1a0f333a0528",
