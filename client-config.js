window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=ca4111f55557",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=ca4111f55557",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=ca4111f55557",
    homeHeroImage: "./assets/track-background.png?v=ca4111f55557",
