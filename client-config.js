window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=abff5b14b76e",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=abff5b14b76e",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=abff5b14b76e",
    homeHeroImage: "./assets/track-background.png?v=abff5b14b76e",
