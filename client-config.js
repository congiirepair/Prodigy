window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=7a6a62ee92d5",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=7a6a62ee92d5",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=7a6a62ee92d5",
    homeHeroImage: "./assets/track-background.png?v=7a6a62ee92d5",
