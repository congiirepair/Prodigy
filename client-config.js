window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=635915283b6e",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=635915283b6e",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=635915283b6e",
    homeHeroImage: "./assets/track-background.png?v=635915283b6e",
