window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=102564447be3",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=102564447be3",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=102564447be3",
    homeHeroImage: "./assets/track-background.png?v=102564447be3",
