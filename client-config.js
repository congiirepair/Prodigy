window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=eca059ff587b",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=eca059ff587b",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=eca059ff587b",
    homeHeroImage: "./assets/track-background.png?v=eca059ff587b",
