window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=43df8fa58cae",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=43df8fa58cae",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=43df8fa58cae",
    homeHeroImage: "./assets/track-background.png?v=43df8fa58cae",
