window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=ac777809dc07",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=ac777809dc07",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=ac777809dc07",
    homeHeroImage: "./assets/track-background.png?v=ac777809dc07",
