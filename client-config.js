window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=085c8a14ee19",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=085c8a14ee19",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=085c8a14ee19",
    homeHeroImage: "./assets/track-background.png?v=085c8a14ee19",
