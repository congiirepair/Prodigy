window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=256fa8ce743b",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=256fa8ce743b",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=256fa8ce743b",
    homeHeroImage: "./assets/track-background.png?v=256fa8ce743b",
