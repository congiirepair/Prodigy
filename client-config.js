window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=0406b04bd3d7",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=0406b04bd3d7",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=0406b04bd3d7",
    homeHeroImage: "./assets/track-background.png?v=0406b04bd3d7",
