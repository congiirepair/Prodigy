window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=97421ac790a7",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=97421ac790a7",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=97421ac790a7",
    homeHeroImage: "./assets/track-background.png?v=97421ac790a7",
