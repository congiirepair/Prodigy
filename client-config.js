window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=e8bd4aac0a8f",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=e8bd4aac0a8f",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=e8bd4aac0a8f",
    homeHeroImage: "./assets/track-background.png?v=e8bd4aac0a8f",
