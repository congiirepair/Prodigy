window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=c140e1d55769",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=c140e1d55769",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=c140e1d55769",
    homeHeroImage: "./assets/track-background.png?v=c140e1d55769",
