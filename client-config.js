window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=4a945d91022f",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=4a945d91022f",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=4a945d91022f",
    homeHeroImage: "./assets/track-background.png?v=4a945d91022f",
