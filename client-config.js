window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=8ec75b5410d6",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=8ec75b5410d6",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=8ec75b5410d6",
    homeHeroImage: "./assets/track-background.png?v=8ec75b5410d6",
