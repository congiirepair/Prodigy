window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=b5c6bc6683de",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=b5c6bc6683de",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=b5c6bc6683de",
    homeHeroImage: "./assets/track-background.png?v=b5c6bc6683de",
