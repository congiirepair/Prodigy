window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=84a4c4130208",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=84a4c4130208",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=84a4c4130208",
    homeHeroImage: "./assets/track-background.png?v=84a4c4130208",
