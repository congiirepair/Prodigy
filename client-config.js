window.RC_DRIFT_CLIENT_CONFIG = {
  ...
  branding: {
    ...
    logoPrimary: "./assets/prodigy-rc-logo-transparent.png?v=5b10c2c18464",
    logoInverted: "./assets/prodigy-rc-logo-white-transparent.png?v=5b10c2c18464",
    logoTreatment: {
      invertLight: false,
      invertDark: false
    },
    logoAlt: "Prodigy RC logo",
    backgroundImage: "./assets/track-background.png?v=5b10c2c18464",
    homeHeroImage: "./assets/track-background.png?v=5b10c2c18464",
